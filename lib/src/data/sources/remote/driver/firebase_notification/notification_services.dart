...
import 'package:untitled/src/data/sources/remote/driver/firebase_notification/models/firebase_notification.dart';
...
class NotificationService {
  ...
  Future<void> initializeNotificationService() async {
    ...
    await SharedPreferenceManager()
        .setFirebaseNotificationToken(notificationToken);
  }
